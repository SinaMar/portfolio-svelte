...
export const allSkills: Skill[] = [
    ...
    createSkill('React', Category.Library, 30, true),
    createSkill('Svelte', Category.Library, 30, false, true, true),
    createSkill('Redux', Category.Library, 30, true),
    createSkill('Chakra UI', Category.Library, 30, false),
    createSkill('RxJS', Category.Library, 10, true, true),
    createSkill('Firebase', Category.Library, 80),
    createSkill('MongoDB', Category.Library, 80),
    createSkill('Unity', Category.Library, 80, true),

    createSkill('NodeJS', Category.Library, 40, true),
    createSkill('Phaser', Category.Library, 30, true),
    createSkill('Jest', Category.Library, 30, true),
    createSkill('Styled Components', Category.Library, 30, true),
    ...
    createSkill('Git', Category.Tool, 10, true),
    ...
    createSkill('Illustrator', Category.Software, 30, false),
    createSkill('Affinity Designer', Category.Software, 30, false),
